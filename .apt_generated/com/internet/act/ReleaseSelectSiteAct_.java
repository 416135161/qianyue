...
public final class ReleaseSelectSiteAct_
    extends ReleaseSelectSiteAct
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.act_release_select_site);
    }
    ...
    public static ReleaseSelectSiteAct_.IntentBuilder_ intent(Context context) {
        return new ReleaseSelectSiteAct_.IntentBuilder_(context);
    }

    public static ReleaseSelectSiteAct_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new ReleaseSelectSiteAct_.IntentBuilder_(fragment);
    }

    public static ReleaseSelectSiteAct_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new ReleaseSelectSiteAct_.IntentBuilder_(supportFragment);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ReleaseSelectSiteAct_.this.clickSearch();
                    }
            ...
            if (view!= null) {
                view.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ReleaseSelectSiteAct_.this.clickItem(position);
                    }
    ...
    public void closeLoading() {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                ReleaseSelectSiteAct_.super.closeLoading();
            }
    ...
    public void showLoading() {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                ReleaseSelectSiteAct_.super.showLoading();
            }
    ...
    public void freshList(final GetSiteListResponse response) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                ReleaseSelectSiteAct_.super.freshList(response);
            }
    ...
    public void doBack() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    ReleaseSelectSiteAct_.super.doBack();
                } catch (Throwable e) {
    ...
    public void getSiteList(final String keyword) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    ReleaseSelectSiteAct_.super.getSiteList(keyword);
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ReleaseSelectSiteAct_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            fragment_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, ReleaseSelectSiteAct_.class);
        }
        ...
        public ReleaseSelectSiteAct_.IntentBuilder_ flags(int flags) {
