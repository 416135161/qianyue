...
public final class StudentDspAct_
    extends StudentDspAct
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.act_student_dsp);
    }
    ...
    public static StudentDspAct_.IntentBuilder_ intent(Context context) {
        return new StudentDspAct_.IntentBuilder_(context);
    }

    public static StudentDspAct_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new StudentDspAct_.IntentBuilder_(fragment);
    }

    public static StudentDspAct_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new StudentDspAct_.IntentBuilder_(supportFragment);
    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        StudentDspAct_.this.clickCallPhone();
                    }
    ...
    public void closeInputKeyboard() {
        handler_.postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                StudentDspAct_.super.closeInputKeyboard();
            }
    ...
    public void showLoading() {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                StudentDspAct_.super.showLoading();
            }
    ...
    @Override
    public void refreshViewByData(final StudentDetailVO result) {
        handler_.post(new Runnable() {
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, StudentDspAct_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            fragment_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, StudentDspAct_.class);
        }
        ...
        public StudentDspAct_.IntentBuilder_ flags(int flags) {
