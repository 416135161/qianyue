...
public final class SelectPhotoDialog_
    extends SelectPhotoDialog
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.dialog_select_photo, container, false);
        }
        return contentView_;
    }
    ...
    public static SelectPhotoDialog_.FragmentBuilder_ builder() {
        return new SelectPhotoDialog_.FragmentBuilder_();
    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        SelectPhotoDialog_.this.clickQX();
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        SelectPhotoDialog_.this.clickXC();
                    }
    ...
    public static class FragmentBuilder_ {
        ...
        public SelectPhotoDialog build() {
            SelectPhotoDialog_ fragment_ = new SelectPhotoDialog_();
